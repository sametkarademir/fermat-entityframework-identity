...
namespace Fermat.EntityFramework.Identity.Domain.Options;
...
public class IdentityOptions
{
    ...
    public UserProfileControllerOptions UserProfileController { get; set; } = new();
}
...
public class UserProfileControllerOptions
{
    public bool Enabled { get; set; } = true;
    public string Route { get; set; } = "api/user-profile";
